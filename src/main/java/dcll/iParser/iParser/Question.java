...
/**
 * <b>Question est la classe représentant une question (simple ou multiple)
 *  avec ses réponses</b>
 * <p>
 ...
 * <li>TypeQuestion : Enumération pour spécifier le type
 * de la question (multiple/simple).</li>
 * </ul>
 * </p>
 * @see Reponse
 */
public class Question {
	...
	/**.
     * Précise si la liste de réponses passées en paramètres
     * sont des réponses juste ou pas
     *
     * @param liste
	...
	public boolean resultOf(ArrayList<String> liste) {
		...
		result = result
				&&
        this.listReponses.get(this.getIndiceOf(str)).getReponseValue();
		}
		return result;
	}
     ...
     * @return l'indice de la réponse cherchée
     * ( retourne -1 si réponse non trouvée)
     * @see Question#listReponses
     */
