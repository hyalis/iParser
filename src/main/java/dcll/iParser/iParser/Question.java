...
/**
 * <b>Question est la classe représentant une question (simple ou multiple) avec ses réponses</b>
 * <p>
 ...
 * <li>TypeQuestion : Enumération pour spécifier le type de la question (multiple/simple).</li>
 * </ul>
 * </p> 
 * @see Reponse
 */
public class Question 
{
	...
	/**
     * Précise si la liste de réponses passées en paramètres sont des réponses juste ou pas 
     * 
     * @param liste
     *            La liste de réponses ( String ) à vérifier
     * 
     * @return True : si la liste des réponses est vrai 
     * 		   false : si la liste des réponses est fausse 
     * @see Question#listReponses
     ...
     * @return l'indice de la réponse cherchée ( retourne -1 si réponse non trouvée) 
     * @see Question#listReponses
     */
     ...
     * 
     * @return True : si la réponse est vrai 
	...
	/**
	 * toString()
     * Spécifie la forme d'écriture de la question 
     * 
     ...
     * 
     * @param l'indice de la réponse à retourner
     * 
